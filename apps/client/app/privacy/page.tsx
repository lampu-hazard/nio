  ...
  return (
    <main className="shell">
      <div className="container-wide max-w-3xl py-16">
        ...
        <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Last updated: June 25, 2025</p>

        <div className="mt-10 space-y-8 leading-7 text-zinc-700 dark:text-zinc-300">
          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">1. What We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">2. How We Use It</h2>
            <ul className="mt-2 list-disc pl-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">3. Data Storage</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">4. Third-Party Services</h2>
            <ul className="mt-2 list-disc pl-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">5. Data Deletion</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">6. Cookies</h2>
            <p className="mt-2">We use a single session cookie (<code className="rounded bg-zinc-100 px-1.5 py-0.5 text-sm text-zinc-950 dark:bg-white/10 dark:text-zinc-50">connect.sid</code>) for authentication. No tracking or analytics cookies are used.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">7. Changes</h2>
            <p className="mt-2">We may update this policy. Continued use of nio after changes constitutes acceptance.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">8. Contact</h2>
