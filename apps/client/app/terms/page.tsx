    ...
    <main className="shell">
      <div className="container-wide max-w-3xl py-16">
        ...
        <div className="mt-10 space-y-8 leading-7 text-zinc-700 dark:text-zinc-300">
          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">1. Acceptance</h2>
            <p className="mt-2">By using nio ("the Service"), you agree to these Terms. If you do not agree, do not use the Service.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">2. Description</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">3. Eligibility</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">4. Your Responsibilities</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">5. Availability</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-zinc-950 dark:text-zinc-50">6. Limitation of Liability</h2>
